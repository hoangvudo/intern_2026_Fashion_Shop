...
const VIP_TIERS = {
  ...
  NONE: {
    label: "MỚI",
    class: "bg-[#F5F3EE] text-[#6F583D] border-transparent",
    bg: "#F5F3EE",
  },
};
...
function VipBadge({ tier }) {
  ...
  return (
    <span
      className={`inline-flex items-center px-2.5 py-1 border rounded-lg font-beVietnamPro text-[11px] font-bold tracking-wider ${current.class}`}
    >
      {current.label}
    </span>
  );
...
function StatusBadge({ active }) {
  return (
    <span
      className={`inline-flex items-center gap-1.5 px-2.5 py-1 font-beVietnamPro text-xs font-medium rounded-full ${
      ...
      >
        ...
        >
          <div className="sticky top-0 z-10 flex items-center justify-between border-b border-[#E8E0D8] bg-white px-6 py-4">
            <h2 className="font-beVietnamPro text-lg font-semibold text-[#1B1C19]">
              Chi tiết khách hàng
            </h2>
            <button
              onClick={onClose}
          ...
          {loading ? (
            ...
            <div className="flex flex-col gap-5 p-6">
              ...
              <div className="border border-[#E8E0D8] p-4 space-y-2">
                <p className="mb-2 font-beVietnamPro text-xs font-semibold uppercase tracking-wider text-[#6F583D]">
                  Thông tin liên hệ
                </p>
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="border border-[#E8E0D8] p-4 text-center">
                  <p className="font-beVietnamPro text-2xl font-bold text-[#1B1C19]">
                    {customer.totalOrders || 0}
                  </p>
                  <p className="mt-1 font-beVietnamPro text-xs text-[#9E8E7E]">
                    Đơn hàng
                  </p>
                </div>
                <div className="border border-[#E8E0D8] p-4 text-center">
                  <p className="font-beVietnamPro text-lg font-bold text-[#1B1C19]">
    ...
    <div className="flex flex-col items-start gap-10 bg-[#FBF9F4] w-full min-h-screen p-8">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-end w-full gap-4">
        <div className="flex flex-col items-start gap-2 w-fit">
          ...
          <p className="text-[#4E453D] font-beVietnamPro text-base leading-6 w-fit">
            Quản lý và theo dõi những khách hàng thân thiết có chi tiêu cao
            nhất.
          </p>
        </div>
      </div>
        ...
        >
          <div className="flex flex-col items-start gap-2 w-full">
            <p className="text-[#4E453D] font-beVietnamPro text-sm leading-6 tracking-[0.1em] font-semibold uppercase">
              DOANH THU KHÁCH HÀNG ĐÃ MUA
            </p>
            <p className="text-[#6F583D] font-beVietnamPro text-2xl font-bold leading-8">
              {statsLoading ? "..." : fmt(stats?.totalCustomerRevenue || 0)}
            </p>
          </div>
            ...
            <div className="flex items-center gap-10 w-full">
              ...
              <div className="flex flex-col items-start gap-1 w-fit">
                ...
                <p className="text-[#1B1C19] font-beVietnamPro text-base font-bold leading-6">
                  {statsLoading
                    ? "..."
                    : `${stats?.newVipMembersThisMonth || 0} thành viên`}
                </p>
              </div>
            </div>
          </div>
        ...
        >
          ...
          <div className="flex pb-4 flex-col items-start w-full mt-2">
            <p className="text-[#4E453D] font-beVietnamPro text-base leading-6 max-w-[80%]">
              Nhóm khách hàng ưu tiên bậc nhất với {stats?.diamondCount || 0}{" "}
              thành viên hiện tại.
            </p>
          </div>
          <button
      ...
      <div className="flex flex-col items-start rounded-lg border border-[#D1C4B9] bg-white w-full overflow-hidden shadow-sm">
        <div className="flex justify-start items-center border-b border-[#D1C4B9] bg-[#F5F3EE] w-full">
          <div className="px-6 py-5 w-[25%] font-beVietnamPro text-xs font-bold tracking-widest text-[#4E453D] uppercase">
            KHÁCH HÀNG
          </div>
          <div className="px-6 py-5 w-[25%] font-beVietnamPro text-xs font-bold tracking-widest text-[#4E453D] uppercase">
            LIÊN HỆ
          </div>
          <div className="px-6 py-5 w-[20%] font-beVietnamPro text-xs font-bold tracking-widest text-[#4E453D] uppercase">
            TỔNG CHI TIÊU
          </div>
          <div className="px-6 py-5 w-[15%] font-beVietnamPro text-xs font-bold tracking-widest text-[#4E453D] uppercase text-center">
            HẠNG
          </div>
          <div className="px-6 py-5 w-[15%] font-beVietnamPro text-xs font-bold tracking-widest text-[#4E453D] uppercase text-right">
            THAO TÁC
          </div>
        </div>
        ...
        <div className="flex flex-col w-full min-h-[400px]">
          {loading ? (
            [...Array(5)].map((_, i) => (
              <div
                key={i}
                className="flex items-center border-b border-[#F0EEE9] w-full px-6 py-4 animate-pulse"
              >
                ...
                <div className="w-[15%] flex justify-center">
                  <div className="w-16 h-6 bg-[#F0EEE9] rounded" />
                </div>
                <div className="w-[15%] flex justify-end">
                  <div className="w-8 h-8 bg-[#F0EEE9] rounded" />
                </div>
              </div>
            ))
          ) : customers.length === 0 ? (
            <div className="flex flex-col items-center justify-center flex-1 py-20">
              ...
              <p className="text-[#9E8E7E] font-beVietnamPro">
              ...
              >
                <div className="w-[25%] flex items-center gap-4">
                  <div
                    ...
                    style={{
                      backgroundColor: VIP_TIERS[c.vipTier]?.bg || "#F5F3EE",
                      color: "#281804",
                    }}
                  >
              ...
              {[...Array(totalPages)].map((_, i) => (
                <button
                  ...
                  className={`w-8 h-8 rounded font-beVietnamPro text-sm font-bold transition-all ${
                    page === i
                      ? "bg-[#6F583D] text-white shadow-md"
                      : "bg-white text-[#696459] border border-[#D1C4B9] hover:bg-[#EAE2D4]"
                  }`}
                >
                  {i + 1}
                </button>
