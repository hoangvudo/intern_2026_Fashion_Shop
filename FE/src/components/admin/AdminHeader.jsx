...
function AdminHeader() {
  ...
  return (
    <header className="fixed left-72 right-0 top-0 z-30 flex h-20 items-center justify-between border-b border-[#D1C4B9] bg-[#FFF] px-10">
      <div className="flex items-center gap-3 border border-[#D1C4B9] px-4 py-2">
