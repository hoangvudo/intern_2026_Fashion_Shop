...
export default function DeleteConfirmModal({ open, product, onConfirm, onCancel, onClose, loading, title, message }) {
  const handleCancel = onCancel || onClose || (() => {})
  
  const displayTitle = title || 'Xoá sản phẩm?'
        ...
        <>
          ...
          >
            <div className="p-8 text-center">
              ...
              <h3 className="mb-2 font-beVietnamPro text-lg font-semibold text-[#1B1C19]">{displayTitle}</h3>
