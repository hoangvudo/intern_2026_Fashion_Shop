...
const COLORS = [
  ...
  { name: "Xanh lá", hex: "#38a169" },
  { name: "Vàng", hex: "#d69e2e" },
  { name: "Cam", hex: "#dd6b20" },
  { name: "Hồng", hex: "#d53f8c" },
  { name: "Tím", hex: "#805ad5" },
  { name: "Be/Kem", hex: "#e8d5b7" },
  { name: "Nâu", hex: "#744210" },
];
      ...
      <div className="relative" ref={colorRef}>
        ...
        >
          {variant.color ? (
            <>
              <span
                className="inline-block h-4 w-4 rounded-full border border-[#D1C4B9]"
            ...
            >
              {COLORS.map((c) => (
                <button
                  ...
                  type="button"
                  onClick={() => {
                    onUpdate(index, "color", c.name);
                    onUpdate(index, "colorHex", c.hex);
                    setColorOpen(false);
                  }}
                  className="flex w-full items-center gap-3 px-3 py-2 text-sm font-beVietnamPro hover:bg-[#F0EEE9]"
                >
                  <span
                    className="h-4 w-4 rounded-full border border-[#D1C4B9] flex-shrink-0"
                    style={{ background: c.hex }}
                  />
                  {c.name}
                  {variant.color === c.name && (
                    <span className="ml-auto text-[#6F583D]">✓</span>
                  )}
                </button>
              ))}
            </motion.div>
...
export default function ProductFormModal({
  ...
  const addVariant = () =>
    setForm((f) => ({
      ...
      variants: [
        ...f.variants,
        { size: "", color: "", colorHex: "", stock: 0, sku: "" },
      ],
    }));
                  ...
                  <div className="space-y-5">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        {form.price && (
                          <p className="mt-1 font-beVietnamPro text-xs text-[#6F583D]">
                      ...
                      <div>
                        ...
                        {form.salePrice && (
                          <p className="mt-1 font-beVietnamPro text-xs text-green-600">
                            {Number(form.salePrice).toLocaleString("vi-VN")}₫
                          </p>
                        )}
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      {[
                        ...
                        <label
                          key={key}
                          className="flex cursor-pointer items-center gap-3 border border-[#D1C4B9] px-4 py-3 hover:bg-[#F0EEE9]"
                        >
                          <input
                            type="checkbox"
                            checked={form[key]}
                ...
                {tab === "variants" && (
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      <div>
                        <h3 className="font-beVietnamPro text-base font-semibold text-[#1B1C19]">
                          Biến thể sản phẩm
                        </h3>
                        <p className="font-beVietnamPro text-sm text-[#9E8E7E]">
                          Tổng tồn kho:{" "}
                          <span className="font-semibold text-[#6F583D]">
                            {totalStock}
                          </span>
                        </p>
                      </div>
                    ...
                    {form.variants.length === 0 ? (
                      ...
                      <div className="space-y-2">
                        ...
                        <div className="grid grid-cols-[1fr_1fr_1fr_80px_40px] gap-2 px-0">
                          {["Size", "Màu sắc", "SKU", "Tồn kho", ""].map(
                            (h, i) => (
                              <span
                                key={i}
                                className="font-beVietnamPro text-xs font-medium uppercase tracking-wider text-[#9E8E7E]"
                              >
                                {h}
                              </span>
                            ),
                  ...
                  <div className="space-y-5">
                    <div>
                      ...
                      <div className="flex flex-col gap-3">
                        <label className="flex cursor-pointer flex-col items-start gap-2 rounded-xl border-2 border-dashed border-[#D1C4B9] bg-[#FBF9F4] px-5 py-6 hover:border-[#6F583D]">
                          <FiUpload className="h-7 w-7 text-[#9E8E7E]" />
                          <div className="flex flex-col">
                            <p className="font-beVietnamPro text-sm text-[#4E453D]">
                              Chọn ảnh để upload
                            </p>
                            <p className="mt-1 font-beVietnamPro text-xs text-[#9E8E7E]">
                              Upload qua /upload/image
                            </p>
                          </div>
                          <input
                            type="file"
                        ...
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              set("thumbnailUrl", e.target.value)
                            }
                            placeholder="https://..."
                            className="w-full border border-[#D1C4B9] px-4 py-3 font-beVietnamPro text-sm text-[#1B1C19] placeholder:text-[#9E8E7E] focus:border-[#6F583D] focus:outline-none"
                          />
                          ...
                          {form.thumbnailUrl && (
                            <div className="border border-[#D1C4B9] p-3">
                              <p className="mb-2 font-beVietnamPro text-xs text-[#9E8E7E] uppercase tracking-wider">
                                Xem trước
                              </p>
                              <img
