const stats = [
  ...
  },
  {
    title: 'Đơn hàng mới',
    value: '156',
    subtitle: 'Đang chờ xử lý: 12',
    badge: { text: 'Hôm nay', variant: 'neutral' },
    icon: (
      <svg width="22" height="24" viewBox="0 0 34 38" fill="none" className="h-6 w-5">
        <path
          d="M11 29C10.45 29 9.97917 28.8042 9.5875 28.4125C9.19583 28.0208 9 27.55 9 27V15C9 14.45 9.19583 13.9792 9.5875 13.5875C9.97917 13.1958 10.45 13 11 13H23C23.55 13 24.0208 13.1958 24.4125 13.5875C24.8042 13.9792 25 14.45 25 15V27C25 27.55 24.8042 28.0208 24.4125 28.4125C24.0208 28.8042 23.55 29 23 29H11Z"
          fill="#6F583D"
        />
      </svg>
    ),
  ...
  },
  {
    ...
    icon: (
      <svg width="22" height="22" viewBox="0 0 38 38" fill="none" className="h-5 w-5">
        <path
          d="M12 29C11.45 29 10.9792 28.8042 10.5875 28.4125C10.1958 28.0208 10 27.55 10 27V15.725C9.7 15.5417 9.45833 15.3042 9.275 15.0125C9.09167 14.7208 9 14.3833 9 14V11C9 10.45 9.19583 9.97917 9.5875 9.5875C9.97917 9.19583 10.45 9 11 9H27C27.55 9 28.0208 9.19583 28.4125 9.5875C28.8042 9.97917 29 10.45 29 11V14C29 14.3833 28.9083 14.7208 28.725 15.0125C28.5417 15.3042 28.3 15.5417 28 15.725V27C28 27.55 27.8042 28.0208 27.4125 28.4125C27.0208 28.8042 26.55 29 26 29H12Z"
          fill="#BA1A1A"
        />
      </svg>
    ),
      ...
      {stats.map((stat) => (
        ...
        >
          <div className="flex items-start justify-between">
            <div className="flex border border-[#D1C4B9] bg-[#F0EEE9] p-2">{stat.icon}</div>
            <div
            ...
            >
              {stat.badge.text}
              {stat.badge.variant === 'success' && stat.badge.text.startsWith('+') && (
                <TrendUpIcon />
              )}
            </div>
          </div>
          ...
          {stat.sparkline && (
            <div className="mt-3 h-10 w-full overflow-hidden opacity-30">
              <svg viewBox="0 0 160 40" fill="none" className="h-full w-full">
                <path
                  d="M0 28C26.6667 17.3333 53.3333 17.3333 80 28C106.667 38.6667 133.333 36 160 20"
                  stroke="#6F583D"
                  strokeWidth="3.2"
                />
              </svg>
