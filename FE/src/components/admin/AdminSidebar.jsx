...
import {
  ...
  FiUsers, FiBarChart2, FiSettings, FiLogOut, FiX, FiStar, FiRotateCcw, FiMessageSquare, FiBookOpen
} from 'react-icons/fi'
...
const navItems = [
  ...
  { to: '/admin/brands', label: 'Thương hiệu', icon: FiTag },
      ...
      <div className="flex items-center justify-between border-b border-[#D1C4B9] px-6 py-6">
        <div className="flex items-center gap-3">
          <div className="flex h-10 w-10 items-center justify-center border border-[#D1C4B9] bg-white">
            <span className="font-beVietnamPro text-sm font-bold tracking-widest text-[#6F583D]">ZY</span>
          </div>
          <div>
