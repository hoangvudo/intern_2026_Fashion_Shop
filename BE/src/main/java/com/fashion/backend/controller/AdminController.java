...
public class AdminController {
    ...
    @PatchMapping("/orders/{id}/confirm-payment")
    public ResponseEntity<AdminOrderDto> confirmPayment(@PathVariable Long id) {
        return ResponseEntity.ok(adminOrderService.confirmPayment(id));
    }
